    ...
    <div class="main-area">
      ...
      <div class="topbar">
        <div class="topbar-left">
          <div class="page-title">
            ...
            <span><?php echo htmlspecialchars($aliment->nom); ?></span>
          </div>
        </div>
      ...
      <div class="content">
        <div class="crud-header">
          <h1 class="crud-title">🔄 Modifier un Aliment</h1>
          ...
          <form method="POST" enctype="multipart/form-data" id="alimentForm">
            <div class="form-section">
              ...
              <div class="form-group full-width">
                ...
                <input type="text" id="nom" name="nom" class="form-input" value="<?php echo htmlspecialchars($aliment->nom); ?>" required maxlength="100" placeholder="ex : Quinoa, Épinards, Saumon…">
            ...
            <div class="form-section">
              ...
              <div class="nutrition-grid">
                <div class="nutrition-item">
                  ...
                  <input type="number" name="calories" value="<?php echo htmlspecialchars($aliment->calories); ?>" min="0" max="9999" step="1" required>
                ...
                <div class="nutrition-item">
                  ...
                  <input type="number" name="proteines" value="<?php echo htmlspecialchars($aliment->proteines); ?>" min="0" max="999.99" step="0.1" required>
                ...
                <div class="nutrition-item">
                  ...
                  <input type="number" name="glucides" value="<?php echo htmlspecialchars($aliment->glucides); ?>" min="0" max="999.99" step="0.1" required>
                  <div class="unit">grammes</div>
                ...
                <div class="nutrition-item">
                  <label>Lipides *</label>
                  <input type="number" name="lipides" value="<?php echo htmlspecialchars($aliment->lipides); ?>" min="0" max="999.99" step="0.1" required>
                  <div class="unit">grammes</div>
            ...
            <div class="form-section">
              ...
              <div class="current-image">
                <img src="../<?php echo htmlspecialchars($aliment->image); ?>" alt="Image actuelle">
                <p>Image actuelle</p>
              </div>
              <?php endif; ?>
              <div class="form-group full-width">
                <div class="file-input-wrapper">
                  ...
                  <label for="image" class="file-input-label">
                    <i>📷</i>
                    <span><?php echo $aliment->image ? 'Changer l\'image' : 'Ajouter une image'; ?></span>
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="btn btn-primary">
                <span>✓</span> Mettre à jour l'aliment
              </button>
            </div>
          </form>
        </div>
