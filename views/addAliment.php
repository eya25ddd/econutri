...
<style>
  ...
  .img-upload-zone strong{color:var(--green-dark);}
  ...
  @media(max-width:768px){.content-section{padding:2rem 1.5rem;}.page-hero{padding:2rem 1.5rem;}.grid-2,.grid-4{grid-template-columns:1fr;}}
</style>
  ...
  <div class="page-hero-inner">
    <div>
      <div class="breadcrumb">
        <a href="index.php">Accueil</a> › <a href="listAliment.php">Aliments</a> › Ajouter
      </div>
      <h1>➕ Ajouter un Aliment</h1>
      <p>Enrichissez la base de données nutritionnelle</p>
    </div>
  </div>
</div>
      ...
      <form method="POST" enctype="multipart/form-data" id="alimentForm" novalidate>
        ...
        <div class="form-group">
          ...
          <input type="text" name="nom" class="form-control <?= isset($errors['nom'])?'is-invalid':'' ?>"
            ...
            placeholder="ex : Quinoa, Épinards, Saumon…" maxlength="100"/>
          ...
          <div class="grid-4">
            ...
            <div>
              <input type="number" name="proteines" class="form-control <?= isset($errors['proteines'])?'is-invalid':'' ?>"
                ...
                value="<?= htmlspecialchars($old['proteines'] ?? '') ?>"/>
            ...
            <div>
              <input type="number" name="glucides" class="form-control <?= isset($errors['glucides'])?'is-invalid':'' ?>"
                ...
                value="<?= htmlspecialchars($old['glucides'] ?? '') ?>"/>
              <div class="helper-text">g / 100g</div>
            ...
            <div>
              <input type="number" name="lipides" class="form-control <?= isset($errors['lipides'])?'is-invalid':'' ?>"
                ...
                value="<?= htmlspecialchars($old['lipides'] ?? '') ?>"/>
              <div class="helper-text">g / 100g</div>
